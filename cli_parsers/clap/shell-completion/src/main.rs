...
//! Usage with zsh:
//! ```console
//! $ cargo run --example worky -- --generate=zsh > /usr/local/share/zsh/site-functions/_completion_derive
//! $ compinit
//! $ ./target/debug/examples/worky --<TAB>
//! ```
//! fish:
//! ```console
//! $ cargo run --example worky -- --generate=fish > completion_derive.fish
